...
Note that the same set of individuals must be present in both input files, and the individual ID in the first column of the cohorts file cannot be present in the rest of that row (i.e., an individual cannot be in their own cohort).
